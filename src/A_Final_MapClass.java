...
public class A_Final_MapClass extends Mapper<Object, Text, Text, Text> {
...
//		String username = split_tweets[1].trim();
		...
		for (int i = 0; i < new_hashtaglist.size(); i++) {
			...
			context.write(new Text(topic), new Text(word_list + " !@#$%^&* " + new_hashtags + " !@#$%^&* " + dayOfWeek));
		}
		// ##### Handle Hashtags End #####
